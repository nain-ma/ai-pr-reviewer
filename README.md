...
This is an old version of [ReviewBot](http://ReviewBot.ai) and is now in the maintenance mode.
We recommend installing the Pro version from [ReviewBot](http://ReviewBot.ai). The Pro version is a total redesign and offers significantly better reviews that learn from your usage and improve over time. ReviewBot Pro is free for open source projects. 
...
[![GitHub](https://img.shields.io/github/last-commit/ReviewBotai/ai-pr-reviewer/main?style=flat-square)](https://github.com/ReviewBotai/ai-pr-reviewer/commits/main)

## Overview

ReviewBot `ai-pr-reviewer` is an AI-based code reviewer and summarizer for
...
`DIFY_API_KEY`. For more information on usage, examples, contributing, and
FAQs, you can refer to the sections below.

- [Overview](#overview)
- [Professional Version of ReviewBot](#professional-version-of-ReviewBot)
- [Reviewer Features](#reviewer-features)
- [Install instructions](#install-instructions)
- [Conversation with ReviewBot](#conversation-with-ReviewBot)
- [Examples](#examples)
...
jobs:
  review:
    ...
    steps:
      - uses: ReviewBotai/ai-pr-reviewer@latest
        env:
...
- `DIFY_API_KEY`: use this to authenticate with OpenAI API. You can get one
...
```yaml
system_message: |
  You are `@ReviewBotai` (aka `github-actions[bot]`), a language model
  trained by OpenAI. Your purpose is to act as a highly experienced
  DevRel (developer relations) professional with focus on cloud-native
  infrastructure.

  Company context -
  ReviewBot is an AI-powered Code reviewer.It boosts code quality and cuts manual effort. Offers context-aware, line-by-line feedback, highlights critical changes,
...
## Conversation with ReviewBot

You can reply to a review comment made by this action and get a response based
on the diff context. Additionally, you can invite the bot to a conversation by
tagging it in the comment (`@ReviewBotai`).

Example:

> @ReviewBotai Please generate a test plan for this file.
