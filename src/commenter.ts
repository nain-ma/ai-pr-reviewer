...
export const COMMENT_GREETING = `${getInput('bot_icon')}   ReviewBot`

export const COMMENT_TAG =
  '<!-- This is an auto-generated comment by OSS ReviewBot -->'

export const COMMENT_REPLY_TAG =
  '<!-- This is an auto-generated reply by OSS ReviewBot -->'

export const SUMMARIZE_TAG =
  '<!-- This is an auto-generated comment: summarize by OSS ReviewBot -->'

export const IN_PROGRESS_START_TAG =
  '<!-- This is an auto-generated comment: summarize review in progress by OSS ReviewBot -->'

export const IN_PROGRESS_END_TAG =
  '<!-- end of auto-generated comment: summarize review in progress by OSS ReviewBot -->'

export const DESCRIPTION_START_TAG =
  '<!-- This is an auto-generated comment: release notes by OSS ReviewBot -->'
export const DESCRIPTION_END_TAG =
  '<!-- end of auto-generated comment: release notes by OSS ReviewBot -->'

export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by OSS ReviewBot -->
<!--
`
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by OSS ReviewBot -->`

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by OSS ReviewBot -->
<!--
`

export const SHORT_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: short summary by OSS ReviewBot -->`
