...
async function run(): Promise<void> {
  ...
  try {
    ...
    warning(
      `Skipped: failed to create summary bot, please check your DIFY_API_KEY: ${e}, backtrace: ${e.stack}`
    )
    return
  }
  ...
  try {
    ...
    warning(
      `Skipped: failed to create review bot, please check your DIFY_API_KEY: ${e}, backtrace: ${e.stack}`
    )
    return
  }
